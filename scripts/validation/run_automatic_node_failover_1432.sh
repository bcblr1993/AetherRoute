...
EXPECTED_DMG_SHA=f7ac1cb4e0ee2d18a0c8019bc1663b09f792b8302e15442e3eca106508ffabc5
CANDIDATE=/Users/chenxu/Downloads/AetherRoute-1.0.0-build-2026081432-Notarized-Test-Candidate
MANIFEST=$CANDIDATE/AetherRoute-1.0.0-build-2026081432-arm64-Notarized-Test.json
DMG=$CANDIDATE/AetherRoute-1.0.0-build-2026081432-arm64-Notarized-Test.dmg
...
FIRST_OTHER_INBOUND=$(tail -c +$((FIRST_OTHER_OFFSET + 1)) "$SECOND_LOG" |
  grep -c 'inbound connection from 192\.168\.64\.4' || true)
...
cp "$0" "$OUTPUT/run_automatic_node_failover_1432.sh"
chmod 400 "$OUTPUT/run_automatic_node_failover_1432.sh"
(
  cd "$OUTPUT"
