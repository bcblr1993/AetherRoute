...
rg -F 'https://aetherroute.pages.dev/releases/1.0.28/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.27/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.26/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.25/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.24/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.23/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.22/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.21/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.20/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.19/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.18/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.17/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.16/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.15/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.14/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://aetherroute.pages.dev/releases/1.0.13/' "$PUBLIC/sitemap.xml" >/dev/null
