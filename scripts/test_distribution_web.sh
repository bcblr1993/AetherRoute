...
for required in \
  ...
  "$PUBLIC/releases/1.0.28/index.html" \
  "$PUBLIC/releases/1.0.27/index.html" \
  "$PUBLIC/releases/1.0.26/index.html" \
  "$PUBLIC/releases/1.0.25/index.html" \
  "$PUBLIC/releases/1.0.24/index.html" \
  ...
  "$PUBLIC/releases/1.0.18/index.html" \
  "$PUBLIC/releases/1.0.17/index.html" \
  "$PUBLIC/releases/1.0.16/index.html" \
  "$PUBLIC/releases/1.0.15/index.html" \
  "$PUBLIC/releases/1.0.14/index.html" \
  "$PUBLIC/releases/1.0.13/index.html" \
...
rg -F 'AetherRoute 1.0.28' "$PUBLIC/index.html" >/dev/null
rg -F '20ab5f308a66d3b8ed10792edc130a03c876f8257675572a23e317bfff72ce28' "$PUBLIC/index.html" >/dev/null
...
rg -F 'https://www.aethernative.com/sitemap.xml' "$PUBLIC/robots.txt" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.28/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.27/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.26/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.25/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.24/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.23/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.22/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.21/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.20/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.19/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.18/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.17/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.16/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.15/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.14/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.13/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.12/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.11/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.10/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.9/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.8/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.7/' "$PUBLIC/sitemap.xml" >/dev/null
rg -F 'https://www.aethernative.com/releases/1.0.1/' "$PUBLIC/sitemap.xml" >/dev/null
